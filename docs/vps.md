...
- Schedule regular backups of the state dir and workspace (see [State Sync](/gateway/state-sync)).
- Need two way sync between the VPS and a local machine? Use [State Sync](/gateway/state-sync).
