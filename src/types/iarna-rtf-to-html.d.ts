declare module "@iarna/rtf-to-html" {
  ...
  export function fromString(value: string, opts: Record<string, unknown>, cb: RtfToHtmlCallback): void;
  ...
  const rtfToHtml: {
    ...
    fromStream: (stream: NodeJS.ReadableStream, opts: Record<string, unknown>, cb: RtfToHtmlCallback) => void;
  };
