...
const FIELD_LABELS: Record<string, string> = {
  ...
  "gateway.sync.enabled": "Gateway Sync Enabled",
  "gateway.sync.direction": "Gateway Sync Direction",
  "gateway.sync.intervalMinutes": "Gateway Sync Interval (min)",
  "gateway.sync.initialDelayMs": "Gateway Sync Initial Delay (ms)",
  "gateway.sync.timeoutMs": "Gateway Sync Timeout (ms)",
  "gateway.sync.rsyncPath": "Gateway Sync rsync Path",
  "gateway.sync.delete": "Gateway Sync Delete",
  "gateway.sync.backupDir": "Gateway Sync Backup Dir",
  "gateway.sync.dryRun": "Gateway Sync Dry Run",
  "gateway.sync.exclude": "Gateway Sync Exclude Patterns",
  "gateway.sync.local.path": "Gateway Sync Local Path",
  "gateway.sync.remote.sshTarget": "Gateway Sync Remote SSH Target",
  "gateway.sync.remote.path": "Gateway Sync Remote Path",
  "gateway.sync.remote.sshIdentity": "Gateway Sync SSH Identity",
  "gateway.sync.remote.sshPort": "Gateway Sync SSH Port",
  "gateway.sync.remote.sshOptions": "Gateway Sync SSH Options",
  "gateway.sync.mappings": "Gateway Sync Extra Mappings",
